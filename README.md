...
欢迎到访
我是Java码农
你可以在LinkedIn、CSDN、Github搜索【KenSpeedIt】找到我
```
...
>在文末有code-past的定义：
```
[code-past]:/img/codepast-logo.jpg "公众号：小振资讯"
```
...
|#|语法| 效果                                         |
|---|----|--------------------------------------------|
|1|`[我的博客](https://cnblogs.com/wzspeed "悬停显示")`| [我的博客](https://cnblogs.com/wzspeed "悬停显示") |
...
|#| 语法                                         |                    效果                    |
|---|--------------------------------------------|:----------------------------------------:|
|1| `[![weibo-logo]](http://weibo.com/x)`      |   [![weibo-logo]](http://weibo.com/x)    |
